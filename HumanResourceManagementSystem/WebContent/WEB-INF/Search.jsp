...
<title>Search Appraisal</title>
</head>
<script type="text/javascript">
	function validate() {
		var flag = true;

		var empId = document.forms["search"]["userid"].value;
		if (empId.length > 1) {
			$("#Iderror").hide();
		}
...
%>
<body>
	<form action="AppraisalController" method="post" name="search">
		<table align="center" style="font-family: arial;">
			<tr>
				<%
					if (!message.equals("")) {
				%>
				<td colspan="3"><span id="message"><font color="red">
							<%
								out.print(message);
							%>
					</font></span></td>
